...
export const materialSchemas = {
  create: z.object({
    ...
    min_stock: z.preprocess((v) => (v === '' || v == null ? 0 : Number(v)), commonSchemas.quantity.default(0)),
    max_stock: z.preprocess((v) => (v === '' || v == null ? 0 : Number(v)), commonSchemas.quantity.default(0)),
    unit_price: z.preprocess((v) => (v === '' || v == null ? 0 : Number(v)), commonSchemas.price.default(0)),
  }),
  update: z.object({
    code: z.string()
      .min(2, 'Malzeme kodu en az 2 karakter olmalı')
