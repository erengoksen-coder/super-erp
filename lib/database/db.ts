...
function initializeDatabase() {
  ...
  db.exec(`
    CREATE TABLE IF NOT EXISTS hr_shift_templates (
      ...
      work_days TEXT DEFAULT '1,2,3,4,5', -- JSON string or comma separated: 1=Mon, 7=Sun
      company_id TEXT DEFAULT '${DEFAULT_COMPANY_ID}',
      branch_id TEXT DEFAULT '${DEFAULT_BRANCH_ID}',
      created_at TEXT DEFAULT CURRENT_TIMESTAMP,
      updated_at TEXT DEFAULT CURRENT_TIMESTAMP,
  ...
  try { db.exec('ALTER TABLE hr_employee_profiles ADD COLUMN shift_id TEXT') } catch {}
  try { db.exec(`ALTER TABLE hr_employee_profiles ADD COLUMN company_id TEXT DEFAULT '${DEFAULT_COMPANY_ID}'`) } catch {}
  try { db.exec(`ALTER TABLE hr_employee_profiles ADD COLUMN branch_id TEXT DEFAULT '${DEFAULT_BRANCH_ID}'`) } catch {}
  ...
  try { db.exec('ALTER TABLE hr_attendance ADD COLUMN late_minutes INTEGER DEFAULT 0') } catch {}
  try { db.exec('ALTER TABLE hr_attendance ADD COLUMN early_exit_minutes INTEGER DEFAULT 0') } catch {}
  try { db.exec('ALTER TABLE hr_attendance ADD COLUMN planned_start TEXT') } catch {}
  try { db.exec('ALTER TABLE hr_attendance ADD COLUMN planned_end TEXT') } catch {}
  try { db.exec(`ALTER TABLE hr_attendance ADD COLUMN company_id TEXT DEFAULT '${DEFAULT_COMPANY_ID}'`) } catch {}
  try { db.exec(`ALTER TABLE hr_attendance ADD COLUMN branch_id TEXT DEFAULT '${DEFAULT_BRANCH_ID}'`) } catch {}
