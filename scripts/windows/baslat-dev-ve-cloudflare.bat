...
echo   Dev + Cloudflare Tunnel - temzileyerek baslatiliyor...
echo.
...
start "Super ERP - Dev" cmd /k "npm run dev || pause"
...
start "Cloudflare Tunnel" cmd /k "npm run tunnel:cloudflare || pause"
echo.
