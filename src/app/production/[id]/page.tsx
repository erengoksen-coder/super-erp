...
export default function ProductionOrderDetailPage() {
  ...
  async function executeCancelProduction() {
    if (!order) return
  ...
  return (
    <div>
      <ConfirmDialog
        ...
        onConfirm={executeCancelProduction}
        title="Üretim Emrini İptal Et"
        message={`${order?.order_number} üretim emrini iptal etmek istiyor musunuz?`}
        variant="danger"
      />
      <div className="mb-6">
