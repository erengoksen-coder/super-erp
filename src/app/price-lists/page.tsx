...
export default function PriceListsPage() {
    ...
    const handleDelete = async (id: string) => {
        if (!await confirmDialog({ title: 'Silme Onayı', message: 'Bu fiyat listesini silmek istediğinize emin misiniz?', variant: 'danger', confirmText: 'Evet, Devam Et', cancelText: 'Vazgeç' })) return
        try {
