...
import { confirmDialog } from '@/lib/store/confirmStore'
...
export default function BudgetsPage() {
  ...
  async function handleDelete(id: string) {
    if (!await confirmDialog({ title: 'Silme Onayı', message: 'Bu bütçe satırını silmek istediğinize emin misiniz?', variant: 'danger', confirmText: 'Evet, Devam Et', cancelText: 'Vazgeç' })) return
    try {
  ...
  async function loadVariance() {
    ...
    try {
      ...
      toast.error(e instanceof Error ? e.message : 'Sapma raporu yüklenemedi')
      setVariance([])
    } finally {
