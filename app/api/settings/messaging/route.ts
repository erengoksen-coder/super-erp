...
function getSetting(db: ReturnType<typeof getDatabase>, key: string): string {
...
function setSetting(db: ReturnType<typeof getDatabase>, key: string, value: string): void {
