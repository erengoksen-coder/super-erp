...
export const POST = withAuth(async (request: NextRequest, user: AuthUser) => {
    ...
    `).run(
        ...
        // Şimdilik sistem modüler kalması için bu entegrasyonu belgenin kendi API'sine bırakabiliriz (Webhook) veya hard-coded yapabiliriz.

        if (approvalRequest.document_type === 'purchase_request') {
            db.prepare(`
