...
import { sendOrderCancelledByDealerNotification } from '@/lib/messaging/order-notification';
...
export const DELETE = withAuth(async (request: NextRequest, { userId }: AuthUser, props: any) => {
    try {
        ...
        try {
            ...
            sendOrderCancelledByDealerNotification({
                order_number: order.order_number || orderId,
                dealer_name: dealerName,
                product_name: order.first_product_name || undefined
