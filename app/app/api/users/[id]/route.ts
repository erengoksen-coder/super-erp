...
export async function PATCH(
  ...
  try {
    ...
    const { is_approved, approved_by, permissions, password, full_name, job_title, role } = body
    ...
    db.transaction(() => {
      ...
      if (is_approved !== undefined || approved_by || full_name !== undefined || job_title !== undefined || role !== undefined) {
