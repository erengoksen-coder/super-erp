...
const AVAILABLE_PAGES: PageOption[] = [
  { path: '/', name: 'Dashboard', category: 'Ana' },
  ...
  { path: '/bom', name: 'Ürün Reçetesi (BOM)', category: 'Üretim' },
]
    ...
    <div className="p-3 sm:p-4 md:p-6 lg:p-8">
      ...
      {(showAddForm || editingUserId) && (
        <div className="bg-gray-900 rounded-lg border border-gray-800 p-4 md:p-6 mb-6">
          ...
          {/* Sayfa İzinleri */}
          <div className="mt-6">
            <h3 className="text-sm font-semibold text-gray-300 mb-3">Sayfa İzinleri</h3>
