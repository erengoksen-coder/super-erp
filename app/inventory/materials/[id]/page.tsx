        ...
        <Card>
          <CardBody className="space-y-4">
            <div className="flex items-center gap-2 border-b border-gray-700 pb-4">
              <button
                style={{ backgroundColor: activeTab === 'in' ? '#16a34a' : '#1f2937' }}
                className="px-4 py-2 text-sm font-medium rounded-md transition-colors text-white hover:opacity-90"
              ...
              <button
                style={{ backgroundColor: activeTab === 'out' ? '#dc2626' : '#1f2937' }}
                className="px-4 py-2 text-sm font-medium rounded-md transition-colors text-white hover:opacity-90"
