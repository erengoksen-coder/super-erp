...
export default function NewSalesOrderPage() {
  ...
  // API Data
  const { data: accounts = [], isLoading: loadingAccounts } = useApi<any[]>('/api/accounts?type=customer')
  const { data: products = [], isLoading: loadingProducts } = useApi<any[]>('/api/inventory/materials') // Ürünler/Malzemeler
